...
for field in data:
    ...
    DIR='<name>%s</name>\n<link>https://github.com/MzDiobolik/Playlist/xunitytalk/playlist/cartoonhd/%s.xml</link>\n<thumbnail>%s</thumbnail>\n\n' % (name,action,iconimage)
